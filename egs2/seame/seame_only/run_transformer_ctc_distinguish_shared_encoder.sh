...
train_set="train"
valid_set="valid"
test_sets="devman devsge" #devman devsge

asr_config=conf/tuning/train_asr_transformer_ctc_e15_distinguish_shared_encoder.yaml
...
./asr.sh \
    ...
    --expdir "exp_256_transformerctc_distinguish_shared_encoder_lr0.0002_5625" \
