...
asr_config=conf/tuning/train_asr_transformer_ctc_e15_distinguish_lid.yaml
...
./asr.sh \
    --ngpu 2 \
    --stage ${stage} \
    --auxiliary_data_tags "lid_bpe_fake" \
    ...
    --expdir "exp_256_transformerctc_distinguish_lid03_langposterior_full_noinjection_lr0.0002_5625" \
    --inference_asr_model "valid.moe_cer_ctc.ave.pth" \
    --inference_nj 32 \
    "$@"
